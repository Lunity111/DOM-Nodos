...
//Estilos 
document.getElementById("titulo").style.background='#f00';//Cambiar color de fondo de el elemento titulo
document.getElementById("contenido").style.borderBlockColor='#f00';
document.getElementById("contenido").style.background='#f9a092';
document.getElementById("contenido").style.lineHeight='50px';




//ACTIVIDAD CRECIÓN DE NODOS
